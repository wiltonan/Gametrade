...
class Gestion_Videojuego{
	...
	public static function mostrarjuego(){
		...
		$sql="select tbl_videojuego.jue_cod, tbl_videojuego.jue_nom, tbl_videojuego.jue_imagen, tbl_videojuego.jue_desc, tbl_videojuego.jue_punto, tbl_videojuego.jue_fech_public, tbl_usuario.usu_num_docum, tbl_consola.cons_nom, tbl_consola.cons_refer, tbl_categoria_jue.cat_nom
						from tbl_videojuego
